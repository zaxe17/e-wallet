            ...
            <div class="grid grid-cols-3 gap-6">
                ...
                <div class="bg-white/30 backdrop-blur-3xl rounded-xl input-shadow p-6 flex flex-col gap-3.5 cursor-pointer transition-all duration-300 ease-in-out hover:scale-105">
                    <div class="bg-[#f5f5f5] px-7 py-3 flex items-center justify-between rounded-lg">
                        ...
                        <!-- PLUS BUTTON -->
                        <span class="openModalBtn icon bg-[#4d4d4d] transition-all duration-300 ease-in-out" style="--svg: url('https://api.iconify.design/lets-icons/add-duotone.svg'); --size: 25px; --icon-color: black;"></span>
                    </div>
                    <!-- BOX CONTENT DATA -->
                ...
                <!-- ADD BUTTON -->
                <div class="openModalBtn bg-white/30 backdrop-blur-3xl rounded-xl input-shadow flex justify-center items-center py-16 cursor-pointer transition-all duration-300 ease-in-out hover:scale-105">
