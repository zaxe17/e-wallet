    ...
    <div class="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-black/45 w-full h-screen flex justify-center items-center z-50 backdrop-blur-[2px]">
        <div class="openModal bg-[#F5F5F5]/80 form-shadow rounded-2xl px-28 py-11 backdrop-blur-sm">
            <div class="flex justify-center gap-5 mb-6">
                <!-- Deposit Button -->
                <button type="button" id="depositBtn" class="text-2xl text-white px-9 py-2 bg-[#485349] rounded-2xl transition-all duration-300 ease-in-out">Deposit</button>

                <!-- Withdrawal Button -->
                <button type="button" id="withdrawalBtn" class="text-2xl text-[#485349] px-9 py-2 rounded-2xl transition-all duration-100 ease-in-out">Withdrawal</button>
            </div>
            ...
            <form id="depositForm" method="POST" action="" class="flex flex-col gap-5">
                ...
                <div class="flex justify-between items-center gap-16">
                    ...
                    <input oninput="capitalizeInput(this)" type="text" name="" id="" class="w-3xs h-8 bg-white/30 backdrop-blur-[15px] rounded-md font-medium input-shadow px-2 py-1 text-sm focus:outline-none">
                </div>
                <div class="flex justify-between items-center gap-16">
                    <label for="" class="text-xl lato-normal font-semibold">Date</label>
                    <input oninput="capitalizeInput(this)" type="date" name="" id="" class="w-3xs h-8 bg-white/30 backdrop-blur-[15px] rounded-md font-medium input-shadow px-2 py-1 text-sm focus:outline-none">
                </div>
                <div class="flex justify-between items-center gap-16">
                    <label for="" class="text-xl lato-normal font-semibold">Savings amount</label>
                    <input oninput="capitalizeInput(this)" type="number" name="" id="" class="w-3xs h-8 bg-white/30 backdrop-blur-[15px] rounded-md font-medium input-shadow px-2 py-1 text-sm focus:outline-none">
                </div>
                <div class="flex justify-between items-center gap-16">
