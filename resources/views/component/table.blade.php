    ...
    <div id="tableWrapper" class="h-[50vh] overflow-y-auto rounded-xl p-3">
        <table class="table-auto w-full text-center border-collapse">
            ...
            <tbody class="bg-[#d1d1d1]/30 input-shadow">
                <tr class="text-sm">
                    <td class="px-4 py-2">{{ $idData }}</td>
                    <td class="px-4 py-2">{{ $dateData }}</td>
                    <td class="px-4 py-2">{{ $categoryData }}</td>
                    <td class="px-4 py-2 text-green-600 font-semibold">+ ₱{{ $amountData }}</td>
