<header class="px-14 py-10 flex justify-between items-center">
    <h1 class="text-[#323d33] text-lg lato">Dashboard</h1>
    ...
    <div class="flex items-center justify-center gap-5">
        ...
        <div class="flex items-center justify-center gap-1">
            ...
            <p class="text-lg text-[#485349] lato">Jan Marc Jacolbia</p>
        </div>
    </div>
</header>